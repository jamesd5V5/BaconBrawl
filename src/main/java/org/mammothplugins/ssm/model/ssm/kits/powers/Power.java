package org.mammothplugins.ssm.model.ssm.kits.powers;
...
public class Power {
    ...
    public void startPreCooldown() {
        ...
        }.runTaskLater(SSM.getInstance(), getSilentSeconds());
    }
...
//                    isCoolingDown = false;
        ...
        }.runTaskTimer(SSM.getInstance(), 0L, 5L);
    }
    ...
    public void startBlocking() {
        ...
        }.runTaskTimer(SSM.getInstance(), 5L, 0L);
    }
